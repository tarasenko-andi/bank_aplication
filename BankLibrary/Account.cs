...
namespace BankLibrary
{
    public abstract class Account : IAccount
    {
        ...
        // Событие возникающее при просмотре счета
        protected internal event AccountStateHandler Checked;
        //Событие для пересылки денег
        protected internal event AccountStateHandler Sended;
        ...
        protected virtual void OnSended(AccountEventArgs e)
        {
            CallEvent(e, Sended);
        }
        ...
        {
            OnChecked(new AccountEventArgs("На счете " + _id + " в данный момент" + CurrentSum, CurrentSum));

        }
        protected internal virtual void Send()
        {
            OnSended(new AccountEventArgs("На счетe: " + _id + " " + CurrentSum, CurrentSum));
        }
        ...
        protected internal virtual void Calculate()
        {
            ...
            _sum = _sum + increment;
            OnCalculated(new AccountEventArgs("Начислены проценты в размере: " + increment + " клиенту" + _id, increment));
        }
