...
namespace BankLibrary
{
    public class Bank<T> where T : Account
    {
        ...
        public void Open(AccountType accountType, decimal sum,
            ...
            AccountStateHandler openAccountHandler, AccountStateHandler checkAccountHandler, AccountStateHandler sendAcoountHandler)
        {
            T newAccount = null;
            ...
            newAccount.Sended += sendAcoountHandler;
        ...
        public void Send(decimal sum, int id1, int id2)
        {
            T account1 = FindAccount(id1);
            T account2 = FindAccount(id2);
            if (account1 == null)
                throw new Exception("Счет 1 не найден");
            if (account2 == null)
                throw new Exception("Счет 2 не найден");
